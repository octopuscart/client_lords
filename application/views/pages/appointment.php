...
foreach ($appointmentdetailslocal as $key => $value) {
    ...
    ?>
                            ...
                            <div class="col-md-3">
                                ...
                                <iframe  frameborder='0' scrolling='no'  marginheight='0' marginwidth='0'  height="100px" width="100%"  src="https://maps.google.com/?q=Far East Mansion, 5-6 Middle Rd, Tsim Sha Tsui, Hong Kong&output=embed">
                                </iframe>  
                            </div>
