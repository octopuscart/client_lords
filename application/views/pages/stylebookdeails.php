    ...
    <div class="container">
        <div class="row">
            <section class="col-lg-9 col-md-9 col-sm-9 m_xs_bottom_30">
                ...
                <article class="clearfix m_bottom_45 m_xs_bottom_30 blog_post">
                    ...
                    <figure >
                        <div class="thumbnail">
                            <center>
                        <img src="<?php echo base_url(); ?>assets/blog/<?php echo $styleobj->image; ?>" alt="" class="r_corners m_bottom_20"  >
                            </center>
                        </div>
                        <figcaption>
                ...
                <div class="blog_side_container w_sm_auto f_left f_xs_none m_xs_bottom_5 margin-bottom-30">
                    ...
                    <div class="fb-share-button" data-href="<?php echo site_url('styleTips/' . $styleobj->id . "/" . $styleobj->title); ?>" data-layout="box_count" data-size="large"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode(site_url('styleTips/' . $styleobj->id . "/lordscustomtailors")); ?>;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div>

                    <!--likes-->

                    <a target="_blank" href="https://api.whatsapp.com/send?text=<?php echo urlencode(site_url('styleTips/' . $styleobj->id . "/lordscustomtailors")); ?>" class="btn btn-default " style="    margin-top: -39px;    background: none;
                       color: green;">
                        <i class="fa fa-whatsapp d_inline_m" style="font-size: 30px;"></i>
                    </a>
                    <!-- AddThis Button BEGIN -->
                    <a target="_blank" href="http://twitter.com/intent/tweet?text=<?php echo urlencode(site_url('styleTips/' . $styleobj->id . "/lordscustomtailors")); ?>" class="btn btn-default " style="    margin-top: -39px;  background: none;
                       color: #007eff;">
            ...
            <aside class="col-lg-3 col-md-3 col-sm-3 side-bar shop-sidbar">
                ...
                <ul class="papu-post margin-top-20 margin-bottom-30">
                    <?php foreach ($stylebook as $key => $value) { ?>

                        <li class="media">
                            <div class="media-left"> 
                                <a href="#"> 
                                    <img class="media-object" src="<?php echo base_url(); ?>assets/blog/<?php echo $value['image']; ?>" alt="" style="background: url(<?php echo base_url(); ?>assets/blog/<?php echo $value['image']; ?>);background-size:cover;    background-position: center;">
