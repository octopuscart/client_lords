...
<div class="fontview_custom customization_block animated zoom "  ng-if="screencustom.view_type == 'front'" >
    ...
    <!--jacket body right-->    <img src="<?php echo custome_image_server; ?>/jacket/overlay/{{img}}" class="fixpos animated" ng-repeat="img in selecteElements[fab.product_id]['Jacket Style'].overlay" >
    ...
    <!--<img src="<?php echo custome_image_server; ?>/jacket/output/{{screencustom.productobj.folder}}/breast_pocket0001.png" class="fixpos animated" >-->
            ...
            <img src="<?php echo custome_image_server; ?>/jacket/output/{{screencustom.productobj.folder}}/sleeve20001.png" class="fixpos animated" >
    ...
    <img src="<?php echo custome_image_server; ?>/jacket/overlay/{{selecteElements[fab.product_id]['Jacket Style'].shirtoverlay}}" class="fixpos animated" >
    
    <img src="<?php echo custome_image_server; ?>/jacket/overlay/hand2.png" class="fixpos animated" >
