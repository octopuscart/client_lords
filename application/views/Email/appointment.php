            ...
            <table class="carttable"  border-color= "#9E9E9E" align="center" border="1" cellpadding="0" cellspacing="0" width="700" style="background: #fff;padding:20px">
                ...
                <tr>
                    <td colspan="6" style="font-size: 12px;">
                        ...
                        <p>We have booked your appointment with our Master Tailor, on <b><?php echo date_format($opdater = date_create($appointment['select_date'] . ' ' . $appointment['select_time']), "l, d F Y"); ?>, <?php echo $appointment['select_time']; ?></b> at <b><?php echo $appointment['hotel']; ?>, <?php echo $appointment['city_state']; ?>, <?php echo $appointment['country']; ?></b>.</p> 
